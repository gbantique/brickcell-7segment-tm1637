...
namespace Brickcell {
     ...
     * TM1637 LED display
     */
    export namespace segment_tm1637 {
        export class TM1637LEDs {
            private buf: Buffer;
            public clk: DigitalPin;
            public dio: DigitalPin;
            private _ON: number;
            public brightness: number;
            public count: number;  // number of LEDs
            ...
            //% parts="TM1637"
            //% subcategory="segment_tm1637"
            public intensity(val: number = 7) {
                if (val < 1) {
                    this.off();
                    return;
                }
             ...
             */
            private _dat(bit: number, dat: number) {
                this._write_data_cmd();
                this._start();
            ...
            //% parts="TM1637"
            //% subcategory="segment_tm1637"
            public showbit(num: number = 5, bit: number = 0) {
            ...
            //% parts="TM1637"
            //% subcategory="segment_tm1637"
            public showDP(bit: number = 1, show: boolean = true) {
                bit = bit % this.count
